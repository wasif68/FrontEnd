...
import { getSavedItems, saveSavedItems } from "@/utils/storage";
...
export default function CareerFeed() {
  ...
  // Load profile from user JSON (consistent with ProfileQuizPage)
  useEffect(() => {
    ...
    <div className="feed">
      ...
      {scored.map((job) => (
        <div key={job.id} className="card">
          ...
          {job.skillHits > 0 && (
            <div className="text-muted" style={{ marginTop: 9, fontSize: 14 }}>
